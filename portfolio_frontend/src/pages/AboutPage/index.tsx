    ...
    <div>
      ...
      <div className="offset">
        <div className="content">
          ...
          <p className="text">
            I am a software engineer studying Computer Science, living in the United States.
            I enjoy playing guitar, spending time with friends and family, and last but not least, programming.
          ...
          <h5 className="mb-2"><strong>Languages</strong></h5>
          <ul>
          ...
          <h5 className="mb-2"><strong>Databases</strong></h5>
          <ul>
            <li className="text">SQLite</li>
            <li className="text">PostgreSQL</li>
          </ul>

          <h5 className="mb-2"><strong>DevOps</strong></h5>
          <ul>
          ...
          <ul>
            <li className="text">
              Administrator of <a href="https://pythondiscord.com/">Python Discord</a>,
              a community focused around the Python language, striving to create new developers
              with over 100,000 members.
            </li>
            <li className="text">
              Participated in the Python Discord <a href="https://pythondiscord.com/pages/code-jams/code-jam-6/">Winter Code Jam 2020</a>
              &nbsp;and <a href="https://pythondiscord.com/pages/events/game-jam-2020/">Game Jam 2020</a>, before becoming an administrator.
